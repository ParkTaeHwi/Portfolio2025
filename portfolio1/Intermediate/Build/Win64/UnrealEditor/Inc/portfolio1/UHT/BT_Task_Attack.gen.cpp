...
#include "portfolio1/BT_Task_Attack.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeBT_Task_Attack() {}

// Begin Cross Module References
AIMODULE_API UClass* Z_Construct_UClass_UBTTaskNode();
PORTFOLIO1_API UClass* Z_Construct_UClass_UBT_Task_Attack();
PORTFOLIO1_API UClass* Z_Construct_UClass_UBT_Task_Attack_NoRegister();
...
template<> PORTFOLIO1_API UClass* StaticClass<UBT_Task_Attack>()
{
	return UBT_Task_Attack::StaticClass();
}
UBT_Task_Attack::UBT_Task_Attack(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
DEFINE_VTABLE_PTR_HELPER_CTOR(UBT_Task_Attack);
UBT_Task_Attack::~UBT_Task_Attack() {}
// End Class UBT_Task_Attack

// Begin Registration
struct Z_CompiledInDeferFile_FID_AUnreal5_Portfolio2025_portfolio1_Source_portfolio1_BT_Task_Attack_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBT_Task_Attack, UBT_Task_Attack::StaticClass, TEXT("UBT_Task_Attack"), &Z_Registration_Info_UClass_UBT_Task_Attack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBT_Task_Attack), 1915272459U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_AUnreal5_Portfolio2025_portfolio1_Source_portfolio1_BT_Task_Attack_h_559080334(TEXT("/Script/portfolio1"),
	Z_CompiledInDeferFile_FID_AUnreal5_Portfolio2025_portfolio1_Source_portfolio1_BT_Task_Attack_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_AUnreal5_Portfolio2025_portfolio1_Source_portfolio1_BT_Task_Attack_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
